...
int main() {
    ...
    cout << "Le nombre total de mariages célébrés entre 2010 et 2015 est de " << somme(t1) << endl;
    cout << "Le nombre moyen de mariages célébrés par an est de " << moyenne(t1) << endl;
    int m1 = indiceMax(t1);
    int m2 = indiceMax(t2);
    cout << "L'année où l'on a célébré le plus de mariages est " << annees[m1] << " avec " << t1[m1] << " mariages" << endl;
    cout << "Le jour de la semaine où l'on a célébré le plus de mariages est le " << jours[m2] << " avec " << t2[m2] << " mariages" << endl;
